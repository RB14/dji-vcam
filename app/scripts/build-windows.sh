...
GO2RTC_DIR="${GO2RTC_DIR:-$WIN_ROOT\\deps\\rtmp\\go2rtc}"
...
powershell.exe -NoProfile -Command "
    ...
    cmake -S '$SRC_WIN' -B '$BUILD_WIN' -G 'Visual Studio 17 2022' -A x64 \`
        -DCMAKE_PREFIX_PATH='$QT_DIR' -DFFMPEG_DIR='$FFMPEG_DIR' -DDJIVCAM_GO2RTC_DIR='$GO2RTC_DIR' -DDJIVCAM_VERSION='$VERSION_FULL' $* | Out-Host
